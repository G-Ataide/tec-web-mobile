...
export default function ProcurarRanking (props){
    ...
    async function handleBarCodeScanned({ type, data }){
        await searchEventRanking(data);
    };

    async function searchEventRanking(eventCode){
        setDisplayQR('none');
        setDisplayTela('flex');
        ...
        if (eventCode=="" || eventCode==null){
            ...
            let response = await fetch(config.urlRoot+`ranking/${eventCode}`);
    ...
    return(
        ...
        <View style={styles.tela__toda(displayTela)}>
            ...
            <View style={css.login__form}>
                ...
                />
                <TouchableOpacity style={css.login__button} onPress={()=>searchEventRanking(eventCodeInput)}>
